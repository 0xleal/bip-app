...
export function NotionActivitySection({
  ...
  const handleSync = useCallback(async () => {
    if (isSyncing || !hasNotionConnection) return;
    ...
    try {
      ...
      if (result.success) {
        ...
        toast.success("Synced successfully", { description });
        ...
        <CardHeader>
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <CardDescription>Pages, databases & edits</CardDescription>
            </div>
          </div>
        </CardHeader>
        <CardContent>
          <div className="text-center py-6">
            <p className="text-sm text-muted-foreground mb-4">
              Connect your workspace to track Notion activity
            </p>
            <Button
        ...
        {error && (
          <div className="text-center py-8 px-4">
            ...
            <p className="text-xs text-muted-foreground">
              Try reconnecting Notion or contact support
            </p>
          </div>
        )}
